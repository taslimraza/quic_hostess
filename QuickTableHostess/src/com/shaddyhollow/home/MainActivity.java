...
import com.shaddyhollow.areaeditor.DataResetUtil;
import com.shaddyhollow.areaeditor.FlurryEvents;
import com.shaddyhollow.areaeditor.R;
import com.shaddyhollow.areaeditor.datastore.CarryoutFactory;
import com.shaddyhollow.areaeditor.datastore.FloorplanFactory;
import com.shaddyhollow.areaeditor.datastore.TabletStateHelper;
...
import com.shaddyhollow.areaeditor.datastore.TableFactory;
import com.shaddyhollow.areaeditor.settings.SettingsActivity;
...
public class MainActivity extends BaseRoboSpiceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_settings.setOnTouchListener(new ButtonHighlighterOnTouchListener(
				btn_settings));

		ImageButton btn_floorplans = (ImageButton) findViewById(R.id.btn_floorplans);
		btn_floorplans.setOnTouchListener(new ButtonHighlighterOnTouchListener(
				btn_floorplans));

		ImageButton btn_sectionplans = (ImageButton) findViewById(R.id.btn_sectionplans);
		btn_sectionplans
				.setOnTouchListener(new ButtonHighlighterOnTouchListener(
						btn_sectionplans));

		ImageButton btn_servers = (ImageButton) findViewById(R.id.btn_servers);
		btn_servers.setOnTouchListener(new ButtonHighlighterOnTouchListener(
				btn_servers));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_dailyreset: {
			DataResetUtil resetUtil = new DataResetUtil(this, contentManager, false);
	...
	public void manageSettings(View view) {
		FlurryAgent.logEvent(FlurryEvents.HOME_SETTINGS.name());
		Intent myIntent = new Intent(this, SettingsActivity.class);
		// myIntent.putExtra("LOCATIONID", Config.getLocationID());
		startActivity(myIntent);
	}

	public void manageFloorplans(View view) {
		FlurryAgent.logEvent(FlurryEvents.HOME_FLOORPLANS.name());
		Intent myIntent = new Intent(MainActivity.this,
				FloorplanManagerActivity.class);
		// myIntent.putExtra("LOCATIONID", Config.getLocationID());
		startActivity(myIntent);
	}

	public void manageSections(View view) {
		FlurryAgent.logEvent(FlurryEvents.HOME_SECTIONPLANS.name());
		Intent myIntent = new Intent(MainActivity.this,
				SectionPlanManagerActivity.class);
		// myIntent.putExtra("LOCATIONID", Config.getLocationID());
		startActivity(myIntent);
	}

	public void manageServers(View view) {
		FlurryAgent.logEvent(FlurryEvents.HOME_SERVERS.name());
		Intent myIntent = new Intent(this, ServerManagerActivity.class);
		// myIntent.putExtra("LOCATIONID", Config.getLocationID());
		startActivity(myIntent);
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case LOGIN:
			if (resultCode == RESULT_OK) {
				isLoggedIn = true;
				getActionBar().setTitle("QuickTable - " + Config.serverName);
