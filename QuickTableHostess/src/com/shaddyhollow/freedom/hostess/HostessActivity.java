...
import com.shaddyhollow.areaeditor.datastore.CarryoutLoader;
import com.shaddyhollow.areaeditor.datastore.DatabaseHelper;
import com.shaddyhollow.areaeditor.datastore.QueuedVisitLoader;
...
public class HostessActivity extends CarryoutActivity implements ActionBar.TabListener, 
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_dailyreset: {
			DataResetUtil resetUtil = new DataResetUtil(this, contentManager, true);
	...
	private class AddSeatedVisitRequestListener extends BaseListener<SeatedVisit> {
		...
		public void onFailure(SpiceException e) {
//			e.printStackTrace();
			FileOperations.errorLog(seatedVisit, e.toString());
		}
		...
		public void onRequestSuccess(SeatedVisit obj) {
			if(seatedVisit!=null && obj!=null) {
				...
				FileOperations.writeToFile(seatedVisit, false);
			}
		}
	}
	...
	public void deleteSeatedVisit(SeatedVisit visit) {
		...
		DeleteSeatedVisitRequest request = new DeleteSeatedVisitRequest(Config.getTenantID(), visit.id);
		request.execute(contentManager, new ClearPatronRequestListener());
	}
	
	private class ClearPatronRequestListener extends BaseListener<Void> {
		@Override
		public void onFailure(SpiceException e) {
	        FileOperations.errorLog(null, e.toString());
		}

		@Override
		public void onRequestSuccess(Void arg0) {
			FileOperations.errorLog(null, "Patron Cleared Successfully!");
		}
