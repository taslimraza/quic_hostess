...
import com.shaddyhollow.areaeditor.NetworkStatus;
import com.shaddyhollow.areaeditor.NetworkStatus.OnStatusChangedListener;
...
//	}
	...
	private class PageCarryoutRequestListener extends BaseListener<Void> {
		@Override
		public void onFailure(SpiceException e) {
			Toast.makeText( CarryoutActivity.this, "Error paging carryout: " + e.getMessage(), Toast.LENGTH_LONG ).show();
		}

		@Override
		public void onRequestSuccess(Void arg0) {
			Toast.makeText( CarryoutActivity.this, "Carryout Paged!", Toast.LENGTH_LONG).show();
		}
